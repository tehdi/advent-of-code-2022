...
if __name__ == '__main__':
    ...
    if mode == REAL:
        ...
        filename = 'customtest1_input.txt'
        target_flow = 2670
    elif mode == CUSTOM2:
        filename = 'customtest2_input.txt'
        target_flow = 12887
    elif mode == CUSTOM3:
        filename = 'customtest3_input.txt'
        target_flow = 1484
    elif mode == CUSTOM4:
        filename = 'customtest4_input.txt'
        target_flow = 3680
    logging.info(f"Executing in {mode} mode. Target flow is {target_flow}")
    ...
    logging.debug(len(target_valves))

    # best_flow = 0
    # while target_flow is None or best_flow < target_flow:
    #     flow_rate = 0
    #     total_flow = 0
    #     time_remaining = 26
    #     target_valves = [valve for valve in valves.values() if valve.flow_rate > 0]
