...
def max_geodes_from_here(income, resources, time_remaining):
    geodes_now = resources[GEODE]
    more_coming = income[GEODE] * time_remaining
    one_more_bot_per_minute = sum([i for i in range(1, time_remaining+1)])
    return geodes_now + more_coming + one_more_bot_per_minute
