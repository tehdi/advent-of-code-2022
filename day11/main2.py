...
if __name__ == '__main__':
    ...
    # logging.info('\n'.join([monkey.pprint() for monkey in monkeys]))
    ...
    monkey_business_level = active_monkeys[0].inspections * active_monkeys[1].inspections
    logging.info(f"Monkey business level: {monkey_business_level}")
